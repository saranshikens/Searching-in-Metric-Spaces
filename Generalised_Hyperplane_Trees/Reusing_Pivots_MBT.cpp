...
int pivotCount = 1; // pivots in the GHT
// 0 - L2 distance
// 1 - L1 distance
// 2 - L_inf distance 
int metricType = 1; 
...
// ---------------------- Build ----------------------
TreeNode* buildGHT(Point arr[], int n, int leaf_size = 4, Point* reusedPivot = nullptr){ // paritioning will stop when the partition size reaches 4
